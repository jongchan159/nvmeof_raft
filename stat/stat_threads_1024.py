...
Payload=1024B, Batch=16, Threads=[1,2,4,8,16,32,64,128]
...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "stat_image")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Raw data (Payload=1024B, Batch=16, Threads=[1,2,4,8,16,32,64,128])
...
FONTSIZE_LABEL = 11
FONTSIZE_TICK  = 10
PAYLOAD_LABEL  = 'Batch=16, Payload=1024B'
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '1_throughput_vs_threads_1KB.png'), dpi=150)
plt.close()
print('Saved: 1_throughput_vs_threads_1KB.png')
...
ax.grid(True, linestyle='--', alpha=0.5)
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '2_latency_avg_vs_threads_1KB.png'), dpi=150)
plt.close()
print('Saved: 2_latency_avg_vs_threads_1KB.png')
...
ax.grid(True, linestyle='--', alpha=0.5)
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '3_latency_p99_vs_threads_1KB.png'), dpi=150)
plt.close()
print('Saved: 3_latency_p99_vs_threads_1KB.png')


# Figure 4: Latency-Throughput Tradeoff (dual x-axis)
# Bottom x-axis: nvmeof_raft scale
...
ax_bot.set_xlabel('Throughput - nvmeof_raft (entries/s)',
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '4_latency_throughput_scatter_1KB.png'), dpi=150)
plt.close()
print('Saved: 4_latency_throughput_scatter_1KB.png')


# Figure 4b: Latency-Throughput — nvmeof_raft only
fig, ax = plt.subplots(figsize=FIGSIZE)
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '4b_latency_throughput_nvmeof_1KB.png'), dpi=150)
plt.close()
print('Saved: 4b_latency_throughput_nvmeof_1KB.png')
...
ax.annotate('better', xy=(0.97, 0.08), xycoords='axes fraction',
            ha='right', va='bottom', fontsize=9, color='gray')
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '4c_latency_throughput_goraft_1KB.png'), dpi=150)
plt.close()
print('Saved: 4c_latency_throughput_goraft_1KB.png')
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '5_bar_comparison_peak_1KB.png'),
            dpi=150, bbox_inches='tight')
plt.close()
print('Saved: 5_bar_comparison_peak_1KB.png')
...
ax.grid(True, linestyle='--', alpha=0.5)
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, '6_latency_combined_1KB.png'), dpi=150)
plt.close()
print('Saved: 6_latency_combined_1KB.png')
